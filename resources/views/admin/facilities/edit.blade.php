<x-admin-layout>
    <div class="p-6 space-y-4 flex flex-col h-full overflow-y-auto custom-scrollbar">
        <div class="flex items-center justify-between shrink-0">
            <div>
                <h1 class="text-xl font-bold text-gray-800 dark:text-white">Edit Facility</h1>
                <p class="text-xs text-gray-500 dark:text-gray-400">Update information and manage facility gallery photos.</p>
            </div>
        ...
        <div
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-3">
                        @foreach ($facility->photos as $photo)
                            <div
                                ...
                                <form action="{{ route('facilities.photo.destroy', $photo->id) }}" method="POST"
            ...
            <form action="{{ route('facilities.update', $facility->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 dark:text-gray-200 mb-1">Facility Name
                            *</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 dark:text-gray-200 mb-1">Location
                            *</label>
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" required
                        class="w-full text-xs p-3 rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-800 dark:text-white">{{ old('description', $facility->description) }}</textarea>
                </div>
